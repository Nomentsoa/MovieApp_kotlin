    ...
    Card(
        ...
        Row(
            ...
            /*    Image(modifier = Modifier.size(50.dp),
                    painter = rememberImagePainter(movie.images[0]), // Replace with your image URL
                    contentDescription = "Description of the image",
                    // Optional: add a placeholder or error image
                    // placeholder = painterResource(R.drawable.your_placeholder),
                    // error = painterResource(R.drawable.your_error_image)
                )
*/
            AsyncImage( modifier = Modifier.size(120.dp, 130.dp),
